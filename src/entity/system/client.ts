...
class RegisteredClient {
     ...
     */
    clientAuthenticationMethods: string = AuthenticationMethodEnum.CLIENT_SECRET_BASIC;
    /**
...
export { RegisteredClient, AuthorizationGrantTypeEnum, FormDialog, AuthenticationMethodEnum }